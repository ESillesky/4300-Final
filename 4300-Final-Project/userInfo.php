...
<form action="checkUpdate.php" method="POST">
            ...
            <input type="text" id="firstName" name="firstName" placeholder= "Update first name">
           
            <label for="ccnum">Last Name</label>
            <input type="text" id="lastName" name="lastName" placeholder="Update last name">
            ...
            <input type="text" id="email" name="email" placeholder="JMD@gmail.com">
        ...
        <input type="submit" name="update1" value="Update Information" class="btn">
      </form>
    </div>
  </div>
  <div class="col-25">
